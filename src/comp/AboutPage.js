...
export const AboutPage = props => (
    <Styles>
        ...
        <Layout>
            ...
            <p className="txtS">
                Children control the world. With CENTRAL shutdown, technology is outlawed. Now the Boy waits, struggling to find 
                a way forward in this brave new world. Today changes all that. DAVID, our “everyman”, has a second chance-he’s been 
                invited for a rare interview with the Boy. But David’s wife, ELOISE, has other plans-she's pregnant, and her child 
                will surely be taken. Her solution? To turn Central back on , once and for all.
            </p>
